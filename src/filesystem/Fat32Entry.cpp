...
u32 Fat32Entry::get_cluster_for_write() {
    ...
    } else if (fat_data.is_cluster_beginning(position)) {   // position points to beginning of new cluster - alloc this new cluster
