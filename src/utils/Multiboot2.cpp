...
Multiboot2 Multiboot2::_instance;
...
Multiboot2::Multiboot2() :
    esh_count(0), mme_count(0), multiboot2_info_totalsize(0), multiboot2_info_addr(0) {
}

void Multiboot2::setup(void *multiboot2_info_ptr) {
